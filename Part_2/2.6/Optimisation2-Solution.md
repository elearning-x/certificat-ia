...
If you have time, you can look at the files {download}`helpers.py <static/helpers_py.pdf>` and {download}`plots.py <static/plots.py.pdf>`, and make sure you understand them.
